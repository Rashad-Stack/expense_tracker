...
export default function CookieConsent() {
  ...
  function handleCookieConsent() {
    setCookie("smartExpenseTracker", true, { path: "/" });
    router.refresh();
  }

  return (
    <section
      className={`fixed bottom-16 right-12 mx-auto  max-w-2xl rounded-2xl border border-gray-200 bg-white p-4 dark:border-gray-700 dark:bg-gray-900 md:flex md:items-center md:gap-x-4`}
    >
      ...
      <div className="mt-6 flex shrink-0 items-center gap-x-4 lg:mt-0">
        <Button size="sm" className="text-sm" onClick={handleCookieConsent}>
          I understand
        </Button>
      </div>
    </section>
